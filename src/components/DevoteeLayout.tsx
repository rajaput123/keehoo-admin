...
const sidebarItems = [
  { label: "Overview", icon: LayoutDashboard, path: "/devotee/overview", description: "Dashboard with devotee statistics" },
  { label: "All Devotees", icon: Users, path: "/devotee/all-devotees", description: "View and manage all devotees" },
  { label: "Analytics", icon: TrendingUp, path: "/devotee/analytics", description: "Monthly registration analytics" },
];
